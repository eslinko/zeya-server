 ...
 */
class TeachingTransactionController extends AppController
{
    /**
     * @inheritdoc
     */
    ...
    {
      $query = TeachingTransaction::find();
	  if(!empty(Yii::$app->request->get())) $query = TeachingTransaction::filterTeachingTransaction();

      $this->setMeta('Teaching Transaction');
